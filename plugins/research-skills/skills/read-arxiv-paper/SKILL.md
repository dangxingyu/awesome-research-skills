...
As for the summary itself, remember that you're usually processing this paper within the context of the current repository, so most often we will be interested in how to apply the paper and its lessons to the current project. Therefore, you should feel free to "remind yourself" of the related project code by reading the relevant parts, and then explicitly make the connection of how this paper might relate to the project or what are things we might be inspired about or try. If there is no surrounding project context, summarize the paper on its own terms.
